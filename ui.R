...
shinyUI(navbarPage(id="meta",
  ...
  tabPanel(id="covid", "COVID19",
          ...
          p(tags$strong("Acknowledgement: These data were obtained from website of Living mapping and living systematic review of Covid-19 studies (", style="color:#2196c4; background-color: #FFFFFF"),
          ...
          tags$strong(") on", textOutput("time", container = span), ".", style="color:#2196c4; background-color: #FFFFFF")),
          ...
          p("Abbreviations: LopRitDarCobUmiInta: Lopinavir Ritonavir or Darunavir Cobicistat Umifenovir Interferon a; 
            LopRitRibIntb1b: Lopinavir Ritonavir Ribavirin Interferon b 1b; Hydroxy_Azith: Hydroxychloroquine Azithromycin; 
            IFN: Interferon; LopRitRibInta: Lopinavir Ritonavir Ribavirin Interferon alpha; LopRitInta: Lopinavir Ritonavir Interferon alpha; 
            Human_umbcord_stemcell_inf: Human umbilical cord mesenchymal stem cell infusion"),
          br(),
         #tableOutput("texttry"),
        ...
        p("Abbreviations (if exists):  LopRitDarCobUmiInta: Lopinavir Ritonavir or Darunavir Cobicistat Umifenovir Interferon a; LopRitRibIntb1b: Lopinavir Ritonavir Ribavirin Interferon b 1b; Hydroxy_Azith: Hydroxychloroquine Azithromycin; IFN: Interferon; 
          LopRitRibInta: Lopinavir Ritonavir Ribavirin Interferon alpha; LopRitInta: Lopinavir Ritonavir Interferon alpha; Human_umbcord_stemcell_inf: Human umbilical cord mesenchymal stem cell infusion"),
         conditionalPanel(condition= "input.networkstyle_sub_COVID=='networkp1'",
                          fluidRow(
                            column(2),
 ...
 tabPanel(id="Intro", "Project introduction"
          ...
          column(10,
                 ...
                 versions of this and any subsequent tools. Please send any feedback to",
                  tags$a(href="mailto:yiqiao.xin@glasgow.ac.uk", "yiqiao.xin@glasgow.ac.uk",target="_blank"), "."),
                br(),
                br(),
                br(),
